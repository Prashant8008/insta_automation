...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  body { width: 1080px; height: 1080px; overflow: hidden; background: linear-gradient(135deg, #0B0F19 0%, #111625 100%); color: #F8FAFC; font-family: 'Plus Jakarta Sans', sans-serif; position: relative; }
  body::before { content: ""; position: absolute; width: 600px; height: 600px; background: radial-gradient(circle, {{BRAND_COLOR}}0f 0%, transparent 70%); top: -100px; right: -100px; pointer-events: none; z-index: 1; }
  body::after { content: ""; position: absolute; width: 600px; height: 600px; background: radial-gradient(circle, {{BRAND_COLOR}}14 0%, transparent 70%); bottom: -100px; left: -100px; pointer-events: none; z-index: 1; }
  ...
  .header-left { display: flex; align-items: center; gap: 12px; font-size: 14px; font-weight: 800; letter-spacing: 2px; text-transform: uppercase; color: #F8FAFC; }
  ...
  .slide-badge { width: 44px; height: 44px; background-color: {{BRAND_COLOR}}; border-radius: 50%; display: flex; justify-content: center; align-items: center; color: #0B0F19; font-weight: 900; font-size: 16px; }

  .content { position: absolute; top: 260px; left: 70px; right: 70px; z-index: 5; }
  .headline { font-size: 85px; font-weight: 900; letter-spacing: -3px; line-height: 1.05; color: #F8FAFC; }
  .headline em { font-family: 'Instrument Serif', serif; font-style: italic; color: {{BRAND_COLOR}}; font-weight: 400; letter-spacing: 0; padding-left: 5px; text-shadow: 0 0 20px rgba(132, 204, 22, 0.2); }
  ...
  .s1-image { width: 340px; height: 340px; object-fit: cover; border-radius: 24px; box-shadow: 0 20px 50px rgba(0,0,0,0.3); border: 1px solid rgba(255,255,255,0.06); }
  .bottom-text { font-size: 28px; font-weight: 500; color: #94A3B8; line-height: 1.4; max-width: 480px; }
  .swipe { font-size: 14px; font-weight: 800; letter-spacing: 2px; text-transform: uppercase; color: {{BRAND_COLOR}}; }
</style>
</head>
<body>
  <div class="header">
...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .top-image { width: 100%; height: 100%; object-fit: cover; object-position: center 20%; filter: brightness(0.75); border-bottom: 1px solid rgba(255,255,255,0.06); }
  .image-fade { position: absolute; bottom: 0; left: 0; right: 0; height: 100px; background: linear-gradient(to bottom, transparent, #0B0F19); }
  ...
  .pill-left { display: flex; align-items: center; gap: 12px; background: rgba(11, 15, 25, 0.8); border: 1px solid rgba(255,255,255,0.1); padding: 12px 24px; border-radius: 40px; color: white; font-size: 14px; font-weight: 800; letter-spacing: 2px; text-transform: uppercase; backdrop-filter: blur(10px); }
  .pill-badge { width: 44px; height: 44px; background-color: rgba(11, 15, 25, 0.8); border: 1px solid rgba(255,255,255,0.1); border-radius: 50%; display: flex; justify-content: center; align-items: center; color: {{BRAND_COLOR}}; font-weight: 900; font-size: 16px; backdrop-filter: blur(10px); }
  ...
  .headline.medium { font-size: 65px; font-weight: 900; letter-spacing: -2px; line-height: 1.05; color: #F8FAFC; }
  .headline.medium em { font-family: 'Instrument Serif', serif; font-style: italic; color: {{BRAND_COLOR}}; font-weight: 400; padding-left: 5px; text-shadow: 0 0 20px rgba(132, 204, 22, 0.2); }
  .subhead { font-size: 32px; font-weight: 700; color: #94A3B8; margin-top: 25px; line-height: 1.3; }
  ...
  .bottom-text { font-size: 26px; font-weight: 500; color: #64748B; line-height: 1.4; max-width: 750px; }
  .swipe { font-size: 14px; font-weight: 800; letter-spacing: 2px; text-transform: uppercase; color: {{BRAND_COLOR}}; }
</style>
</head>
<body>
...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .huge-number { font-size: 200px; font-weight: 900; letter-spacing: -8px; line-height: 0.9; margin-bottom: 10px; display: inline-block; color: #F8FAFC; }
  ...
  .thick-circle { width: 150px; height: 150px; border: 12px solid {{BRAND_COLOR}}; border-radius: 50%; display: flex; flex-direction: column; justify-content: center; align-items: center; box-shadow: 0 0 20px rgba(132, 204, 22, 0.15); }
  .circle-text { font-size: 24px; font-weight: 900; line-height: 1; color: #F8FAFC; }
  .circle-sub { font-family: 'Instrument Serif', serif; font-style: italic; font-size: 22px; color: #94A3B8; margin-top: 4px; }
...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .huge-number { font-size: 160px; font-weight: 900; letter-spacing: -6px; line-height: 0.9; margin-bottom: 10px; color: #F8FAFC; }
  .headline.medium { font-size: 55px; font-weight: 900; letter-spacing: -1.5px; line-height: 1.1; color: #F8FAFC; }
  .headline.medium em { font-family: 'Instrument Serif', serif; font-style: italic; color: {{BRAND_COLOR}}; font-weight: 400; padding-left: 5px; text-shadow: 0 0 20px rgba(132, 204, 22, 0.2); }
  .subhead { font-size: 26px; font-weight: 700; color: #94A3B8; margin-top: 15px; }

  .s6-image { width: 420px; height: 420px; object-fit: cover; border-radius: 32px; box-shadow: 0 20px 50px rgba(0,0,0,0.3); border: 1px solid rgba(255,255,255,0.06); }
...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .headline { font-size: 85px; font-weight: 900; letter-spacing: -3px; line-height: 1.05; color: #F8FAFC; }
  .headline em { font-family: 'Instrument Serif', serif; font-style: italic; color: {{BRAND_COLOR}}; font-weight: 400; padding-left: 5px; text-shadow: 0 0 20px rgba(132, 204, 22, 0.2); }
  
  .s7-line { width: 60px; height: 4px; background-color: {{BRAND_COLOR}}; margin: 40px 0; }
  .subhead { font-size: 32px; font-weight: 600; color: #94A3B8; max-width: 900px; line-height: 1.4; }
  ...
  .s7-pill { background-color: #84CC16; color: #0B0F19; padding: 20px 40px; border-radius: 50px; font-size: 20px; font-weight: 900; display: inline-block; letter-spacing: -0.5px; box-shadow: 0 4px 20px rgba(132, 204, 22, 0.3); }
  .s7-pill em { font-family: 'Instrument Serif', serif; font-style: italic; color: #0B0F19; font-weight: 400; margin-left: 5px; font-size: 24px; }
</style>
</head>
<body>
  <div class="header">
